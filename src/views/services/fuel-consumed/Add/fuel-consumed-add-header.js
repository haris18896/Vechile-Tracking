...
function FuelConsumedAddHeader(props) {
  ...
  return (
    ...
    <Grid container spacing={4} alignItems="center">
        ...
        <HeaderLabel>{pathname === "/services/fuel-consumed/[id]" ? 'Edit Fuel Consumed Details' : 'Add Fuel Consumed Details'}</HeaderLabel>
        </Grid>
...
export default FuelConsumedAddHeader
