...
function MaintenanceAddHeader(props) {
  ...
  return (
    <ServicesWrapper>
      ...
      <HeaderLabel>{pathname === "/services/maintenance-module/[id]" ?  "Edit Maintenance Details" : "Add Maintenance Details"}</HeaderLabel>
      </Grid>
...
export default MaintenanceAddHeader
