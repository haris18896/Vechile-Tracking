...
import { SettingsWrapper, Title } from 'src/styles/pages/services/edit'
...
function FineManagementAddHeader(props) {
  ...
  return (
    <ServicesWrapper>
      ...
      <HeaderLabel>{router.pathname === '/services/fine-management/add' ? 'Add Fine Details' : 'Edit Fine Details'}</HeaderLabel>
      </Grid>
...
export default FineManagementAddHeader
