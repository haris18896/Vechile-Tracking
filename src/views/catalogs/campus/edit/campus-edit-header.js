...
function AddEditCampusHeader({ loading, router, submitHandler }) {
  return (
    ...
    <Box sx={{ flexGrow: 1 }}>
     <Grid container spacing={4} xs={{ alignItems: 'center' }}>
       ...
       <HeaderLabel>
              {router.pathname === '/catalogs/campus/add-edit/add' ? 'Add Campus' : 'Edit Campus'}
        </HeaderLabel>
       </Grid>
...
export default AddEditCampusHeader

AddEditCampusHeader.propTypes = {
