...
function DevicesAddHeader(props) {
  ...
  return (
    <ServicesWrapper>
      ...
      <HeaderLabel>{pathname === "/catalogs/devices/id]" ?  "Edit Device Details" : "Add Device Details"}</HeaderLabel>
      </Grid>
...
export default DevicesAddHeader
