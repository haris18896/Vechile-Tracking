...
function AddEditLiveLocationHeader({ loading, router, submitHandler }) {
  return (
    <SettingsWrapper>
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={4} sx={{ justifyContent: 'space-between' }}>
          <Grid item xs={12} sm={6} md={4}>
            <FieldWrapper>
              <HeaderLabel>
                {router.pathname === '/catalogs/live-location/edit/add' ? 'Add Live Location' : 'Edit Live Location'}
              </HeaderLabel>
            </FieldWrapper>
          </Grid>
...
export default AddEditLiveLocationHeader

AddEditLiveLocationHeader.propTypes = {
