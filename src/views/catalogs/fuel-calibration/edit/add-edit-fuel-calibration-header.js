...
function AddEditFuelCalibrationHeader({ loading, router, submitHandler }) {
  return (
    <SettingsWrapper>
      <Grid container spacing={4} sx={{ justifyContent: 'space-between' }}>
        <Grid item xs={12} sm={6} md={4}>
          <FieldWrapper>
            <HeaderLabel>
              {router.pathname === '/catalogs/fuel-calibration/edit/add'
                ? 'Add Fuel Calibration'
                : 'Edit Fuel Calibration'}
            </HeaderLabel>
          </FieldWrapper>
        </Grid>
...
export default AddEditFuelCalibrationHeader

AddEditFuelCalibrationHeader.propTypes = {
