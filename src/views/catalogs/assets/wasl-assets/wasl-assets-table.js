...
function WaslAssetsTable(props) {
  const { rows, page, limit, total, loading, handleLimitChange, handlePageChange, ability, updateWaslAsset } = props
  ...
  return (
    <TableWrapper>
      {loading && <Spinner />}
      <DataTable
        columns={columns({ ability, updateWaslAsset })}
...
export default WaslAssetsTable
