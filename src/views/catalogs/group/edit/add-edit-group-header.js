...
function AddEditGroupHeader({ loading, router, submitHandler }) {
  return (
    <SettingsWrapper>
      <Grid container spacing={4} sx={{ justifyContent: 'space-between' }}>
        <Grid item xs={12} sm={6} md={4}>
          <FieldWrapper>
            <HeaderLabel>
              {router.pathname === '/catalogs/group/edit/add' ? 'Add Vehicle Details' : 'Edit Vehicle Details'}
            </HeaderLabel>
          </FieldWrapper>
        </Grid>
...
export default AddEditGroupHeader

AddEditGroupHeader.propTypes = {
