...
function AddEditWorkingHoursHeader({ loading, router, submitHandler }) {
  return (
    <SettingsWrapper>
      <Grid container spacing={4} sx={{ justifyContent: 'space-between' }}>
        <Grid item xs={12} sm={6} md={4}>
          <FieldWrapper>
            <HeaderLabel>
              {router.pathname === '/catalogs/working-hours/edit/add' ? 'Add Working Hours' : 'Edit Working Hours'}
            </HeaderLabel>
          </FieldWrapper>
        </Grid>
...
export default AddEditWorkingHoursHeader

AddEditWorkingHoursHeader.propTypes = {
