...
function AddEditInventoryHeader({ loading, router, submitHandler }) {
  return (
    <SettingsWrapper>
      <Grid container spacing={4} sx={{ justifyContent: 'space-between' }}>
        <Grid item xs={12} sm={6} md={4}>
          <FieldWrapper>
            <HeaderLabel>
              {router.pathname === '/catalogs/inventory/edit/add' ? 'Add Inventory' : 'Edit Inventory'}
            </HeaderLabel>
          </FieldWrapper>
        </Grid>
...
export default AddEditInventoryHeader

AddEditInventoryHeader.propTypes = {
