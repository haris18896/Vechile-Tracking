...
function WaslDriverTable(props) {
  const { rows, page, limit, total, loading, handleLimitChange, handlePageChange, ability, updateWaslDriver } = props
  ...
  return (
    <TableWrapper>
      {loading && <Spinner />}
      <DataTable
        columns={columns({ ability, updateWaslDriver })}
...
export default WaslDriverTable
