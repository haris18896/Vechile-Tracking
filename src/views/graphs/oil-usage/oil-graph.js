...
function OilGraph({ slug, onChangeHandler, customers }) {
  ...
  return (
    <GraphsWrapper>
      ...
      <ResponsiveContainer height={580} width='100%'>
        <LineChart data={data} margin={{ top: 50, right: 20, bottom: 80, left: 10 }} width='100%' height={300}>
          <CartesianGrid vertical={false} stroke='#D1D5DD' />
