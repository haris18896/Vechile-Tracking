...
function FuelGraph({ slug, onChangeHandler, customers }) {
          ...
          <Grid container columnSpacing={8} rowSpacing={5}>
            ...
            <Grid item>
              <ContentContainer align='center'>
                ...
                <TextWrapper>
                  <Subtitle size='13px'>FUEL VOLUME 1 (LT)</Subtitle>
                </TextWrapper>
              </ContentContainer>
            </Grid>
            ...
            <Grid item>
              <ContentContainer align='center'>
                ...
                <TextWrapper>
                  <Subtitle size='13px'>FUEL VOLUME 2 (LT)</Subtitle>
                </TextWrapper>
              </ContentContainer>
            </Grid>
          </Grid>
