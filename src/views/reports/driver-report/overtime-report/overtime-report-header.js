...
function OvertimeReportHeader({ slug, onChangeHandler, customers }) {
            ...
            <Grid container columnSpacing={5} rowSpacing={4}>
              <Grid item xs={12} sm={6} md={4}>
                ...
                <Grid item xs={12} sm={9}>
                  ...
                  <Grid item xs={10.5} md={9} pr={{ xs: 5, md: 0 }}>
                    <Select
                      variant='outlined'
                      displayEmpty
                      value={trackVal}
                  ...
                  <Grid item xs={1} md={3} pl={3} display="flex" justifyContent={{ xs: 'end', md: 'start'}} ml={{xs: 'auto', md:'0'}}>
                    <FormControlLabel
                     sx={{marginRight: { xs: 0, md: 4}}}
                      control={<Checkbox defaultValue={false} sx={{padding: 2}} />}
...
export default OvertimeReportHeader

OvertimeReportHeader.propTypes = {
