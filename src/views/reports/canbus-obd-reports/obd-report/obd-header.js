...
function OBDReportHeader({ slug, onChangeHandler, customers }) {
          ...
          <Grid item xs={12} md={10} lg={8} xl={7} flexWrap='wrap'>
            <Grid container columnSpacing={5} rowSpacing={4}>
              ...
              <Grid item xs={12} sm={6} md={4.5}>
                <Grid container alignItems='center' rowSpacing={1} mb={3}>
                  <Grid item xs={12} sm={3} md={4.5}>
                    <Typography variant='body' sx={{ paddingRight: {xs: 3, md: 0},fontWeight: '600', textAlign: 'center' }}>
                      From Time
                    </Typography>
                  </Grid>
                  <Grid item xs={12} sm={9} md={7.5}>
...
export default OBDReportHeader

OBDReportHeader.propTypes = {
