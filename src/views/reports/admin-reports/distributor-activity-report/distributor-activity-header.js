...
function DistributeActivityHeader({ slug, onChangeHandler, customers }) {
                  ...
                  <Grid item xs={12}>
                    ...
                    >
                      {assetOptions?.map((asset, index) =>
                        index === 0 ? (
                          <MenuItem key={index} value=''>
                            <PlaceholderText>Activity Name</PlaceholderText>
                          </MenuItem>
                        ) : (
...
export default DistributeActivityHeader

DistributeActivityHeader.propTypes = {
