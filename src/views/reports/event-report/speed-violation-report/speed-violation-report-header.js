...
function SpeedViolationReportHeader({ slug, onChangeHandler, customers }) {
  ...
  // const { getTableHeight, showTableData } = useTableContext()
...
export default SpeedViolationReportHeader

SpeedViolationReportHeader.propTypes = {
