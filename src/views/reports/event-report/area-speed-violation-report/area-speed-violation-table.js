...
function AreaSpeedViolationTable() {
  // Getting table height and tableData (true, false) state from Table Context
  const { tableHeight, tableData } = useContext(TableUIContext)

  // Passing table height from context to useStyles -> for dynamic table height
...
export default AreaSpeedViolationTable
