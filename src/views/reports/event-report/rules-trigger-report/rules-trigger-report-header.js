...
function RulesTriggerReportHeader({ slug, onChangeHandler, customers }) {
                  ...
                  <Grid item xs>
                    ...
                    >
                      {assetOptions?.map((asset, index) =>
                        index === 0 ? (
                          <MenuItem key={index} value=''>
                            <PlaceholderText>Select Rule</PlaceholderText>
                          </MenuItem>
                        ) : (
                          <MenuItem key={index} value={asset.slug}>
                            {asset.name}
...
export default RulesTriggerReportHeader

RulesTriggerReportHeader.propTypes = {
