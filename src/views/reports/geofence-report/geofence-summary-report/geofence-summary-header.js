...
function GeofenceSummaryHeader({ slug, onChangeHandler, customers }) {
        ...
        <Grid container rowSpacing={5} columnSpacing={6} xs={{ alignItems: 'center' }}>
          ...
          <Grid item xs={12} md={6} lg={4} xl={5}>
            <Grid container rowSpacing={4} columnSpacing={3} flexWrap='wrap'>
              ...
              <Grid item>
                <ButtonIcon sx={{ width: 150 }} color='primary-outlined' startIcon={'mdi:paper-text-outline'}>
                  Summary
                </ButtonIcon>
              </Grid>
...
export default GeofenceSummaryHeader

GeofenceSummaryHeader.propTypes = {
