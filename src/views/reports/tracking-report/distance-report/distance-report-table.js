...
function DistanceReportTable({ showTableData }) {
  ...
  return (
    <TableWrapper>
      ...
      >
        ...
        >
          Detailed Distance Record
        </AccordionSummary>
        <AccordionDetails sx={{ height: { xs: '100%',  sm: `calc(100vh - ${tableHeight}` } }} overflowY="auto" style={{ padding: 0, background: '#fff', paddingBottom: '1.5rem'}}>
          <DataTable
            columns={columns()}
            data={tableData && rows}
            pointerOnHover
