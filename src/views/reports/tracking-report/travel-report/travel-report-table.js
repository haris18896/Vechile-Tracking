  ...
  return (
    <TableWrapper>
      ...
      >
        ...
        ></AccordionSummary>
        <AccordionDetails sx={{ height: { xs: '100%',  sm: `calc(100vh - ${tableHeight}` } }} overflowY="hidden" style={{ padding: 0, background: '#fff'}}>
          <DataTable
            columns={columns()}
            data={tableData && rows}
            pointerOnHover
      ...
      >
        ...
        <AccordionDetails
         sx={{ height: { xs: '100%',  sm: `calc(100vh - ${tableHeight}` } }} overflowY="hidden" style={{ padding: 0, background: '#fff'}}
        >
          <DataTable
            columns={columns()}
            data={tableData && rows}
