...
function ExIdleReportHeader({ slug, onChangeHandler, customers, toggleTableData }) {
  ...
  const intervalOptions = ['5', '3', '2', '10']

  const timeOptions = ['5 am', '3 am', '2 am', '10 pm']
  ...
  const { trackVal, assetName, interval, time } = values
                  ...
                  <Grid item xs={12} sm={9} md={7.5}>
                    ...
                    >
                      {intervalOptions.map((name, index) =>
                        index === 0 ? (
                          <MenuItem key={name} value=''>
                            <PlaceholderText> 0</PlaceholderText>
                          </MenuItem>
                        ) : (
                          <MenuItem key={name} value={name}>
                            {name}
...
export default ExIdleReportHeader

ExIdleReportHeader.propTypes = {
