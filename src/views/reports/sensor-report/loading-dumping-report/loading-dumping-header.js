...
function LoadingDumpingHeader({ slug, onChangeHandler, customers }) {
                  ...
                  <Grid item xs>
                    ...
                    >
                      {assetOptions?.map((asset, index) =>
                        index === 0 ? (
                          <MenuItem key={index} value=''>
                            <PlaceholderText>Select Type</PlaceholderText>
                          </MenuItem>
                        ) : (
                          <MenuItem key={index} value={asset.slug}>
                            {asset.name}
...
export default LoadingDumpingHeader

LoadingDumpingHeader.propTypes = {
