...
function SFDAReportHeader({ slug, onChangeHandler, customers }) {
                  ...
                  <Grid item xs={12} md={9}>
                    ...
                    >
                      {assetOptions?.map((asset, index) =>
                        index === 0 ? (
                          <MenuItem key={index} value=''>
                            <PlaceholderText>Warehouse</PlaceholderText>
                          </MenuItem>
                        ) : (
                  ...
                  <Grid item xs>
                    ...
                    >
                      {assetOptions?.map((asset, index) =>
                        index === 0 ? (
                          <MenuItem key={index} value=''>
                            <PlaceholderText>Inventories</PlaceholderText>
                          </MenuItem>
                        ) : (
                          <MenuItem key={index} value={asset.slug}>
                            {asset.name}
...
export default SFDAReportHeader

SFDAReportHeader.propTypes = {
