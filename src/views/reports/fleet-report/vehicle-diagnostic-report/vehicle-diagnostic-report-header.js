...
function VehicleDiagnosticReportHeader({ slug, onChangeHandler, customers, toggleTableData, getTableHeight }) {
...
export default VehicleDiagnosticReportHeader

VehicleDiagnosticReportHeader.propTypes = {
