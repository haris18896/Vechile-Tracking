...
function LiveTravelersFooter({ slug, onChangeHandler, customers }) {
    ...
    <TrackingWrapper>
      <Grid container justifyContent='end'>
        <FieldHorizontalWrapper sx={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
          <ButtonIcon sx={{ width: 150 }} startIcon={'uil:times'} color='error-outlined' onClick={() => handleOpen()}>
            Clear All
          </ButtonIcon>
...
export default LiveTravelersFooter

LiveTravelersFooter.propTypes = {
