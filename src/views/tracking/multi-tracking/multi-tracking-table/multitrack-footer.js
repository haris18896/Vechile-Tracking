...
function MultiTrackFooter({ slug, onChangeHandler, customers, clearCheckedRows }) {
    ...
    <TrackingWrapper>
      <Grid container justifyContent='end'>
        <FieldHorizontalWrapper sx={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
          <ButtonIcon sx={{ width: 150 }} startIcon={'uil:times'} color='error-outlined' onClick={clearCheckedRows}>
            Clear All
          </ButtonIcon>
...
export default MultiTrackFooter

MultiTrackFooter.propTypes = {
