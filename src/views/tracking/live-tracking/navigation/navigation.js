...
function Navigation(props) {
  ...
  const schema = Yup.object().shape({
    starting_point: Yup.string().required('Starting Point is required'),
    ending_point: Yup.string().required('Ending Point is required'),
  })
          ...
          >
            ...
            >
              ...
              <Grid container mt="64px">
                <Grid item xs={12}>
                  <HeaderLabel sx={{ color: '#556485', fontSize: '1rem'}}>Navigation Window</HeaderLabel>
                </Grid>
