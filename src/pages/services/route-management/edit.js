  ...
  return (
    <ServiceWrapper>
      <RouteAddHeader
        ...
        redirectURL='/services/route-management'
        clearMap={clearMap}
      />
...
RouteManagementEdit.acl = {
  action: 'manage',
  subject: 'manage-route-management'
}

RouteManagementEdit.AuthGuard = true

export default RouteManagementEdit
