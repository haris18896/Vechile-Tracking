...
import RouteManagementHeader from 'src/views/services/route-management/route-management-header'
import RouteManagementTable from 'src/views/services/route-management/route-management-table'
  ...
  return (
    <ServiceWrapper>
      <RouteManagementHeader
        ...
        redirectURL='/services/route-management/edit'
      />
...
RouteManagement.AuthGuard = true
