...
function OrderManagementEdit() {
  ...
  const orderData =  data?.find((data) => data.id === id);
    ...
    const formik = useFormik({
      initialValues: {
        account: orderData?.customer || '',
        cost: orderData?.cost || '',
        work_order_no: orderData?.work_order_no || '',
        labor_time: orderData?.labor_time || '',
        vehicle_id: orderData?.vehicle_id || '',
        order_status: orderData?.order_status || '',
        service_type: orderData?.service_type || '',
        date_in: moment(orderData?.date_in).toDate() || '',
        technician_name: orderData?.technician_name || '',
        date_out: moment(orderData?.date_out).toDate() || '',
