...
import PartManagementHeader from 'src/views/services/part-management/part-management-header'
import PartManagementTable from 'src/views/services/part-management/part-management-table'
  ...
  return (
    <ServiceWrapper>
      <PartManagementHeader
        ...
        redirectURL='/services/part-management/edit'
      />
      <PartManagementTable
        rows={rows}
        page={page}
