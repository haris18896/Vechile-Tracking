...
import MaintenanceModuleHeader from 'src/views/services/maintenance-module/maintenance-module-header'
import MaintenanceModuleTable from 'src/views/services/maintenance-module/maintenance-module-table'
  ...
  return (
    <ServiceWrapper>
      <MaintenanceModuleHeader
        ...
        redirectURL='/services/maintenance-module/add'
      />
      <MaintenanceModuleTable
        rows={open && rows}
        page={page}
        total={total}
        limit={limit}
...
MaintenanceModule.acl = {
  action: 'manage',
  subject: 'manage-maintenance-module'
}

MaintenanceModule.AuthGuard = true
