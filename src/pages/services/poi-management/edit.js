...
import PoiAddHeader from 'src/views/services/poi-management/Add/poi-add-header'
import PoiManagement from 'src/views/services/poi-management/Add/poi-management'
import { ServiceWrapper } from 'src/styles/pages/services'

function PoiManagementEdit() {
...
export default PoiManagementEdit
