...
import { getAssetByIdAction, registerAssetAction } from 'src/store/catalogs/assets/assetsActions'
...
function AddEditAsset() {
  ...
  const getAsset = useSelector(state => state.assets?.getAsset)
  ...
  useEffect(() => {
    if (id) {
      dispatch(getAssetByIdAction(id))
    }
  }, [id])
  ...
  const schema = Yup.object().shape({
    ...
    registration_expiry_date: Yup.string().required('Registration Expiry is required'),
    ...
    installer_id: Yup.string().required(),
    installation_type_id: Yup.string().required('Installation Type is required'),
    communication_id: Yup.string().required('Communication is required'),
    plate_type_id: Yup.string().required('Plate type is required'),
    sim_id: Yup.string().required('Sim is required'),
    is_wasl: Yup.boolean(),
    military_pass_number: Yup.string().required('Military number is required'),
    ...
    idle_limit: Yup.string().required('Idle limit is required'),
