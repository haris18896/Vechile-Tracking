...
import OilHeader from 'src/views/graphs/oil-usage/oil-header'
import OilGraph from 'src/views/graphs/oil-usage/oil-graph'
...
OilUsage.AuthGuard = true

export default OilUsage
